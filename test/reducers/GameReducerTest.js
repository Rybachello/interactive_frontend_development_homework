...
describe('game reducer', () => {
    ...
    describe('create game', () => {
        it('create word game when number game is created', () => {
            ...
            const stateAfterFirstGameCreation = reducer(undefined, createGamePostSucceeded(
                {
                    fetchState: {
                        inFlight: false
                    },
            ...
            const stateAfterSecondGameCreation = reducer(stateAfterFirstGameCreation, createGamePostSucceeded({
                fetchState: {
                    inFlight: false
                },
    ...
    describe('number guess', () => {
        ...
        it('send moves when guess post requested', () => {
            ...
            expect(
                reducer(stateAfterFirstGameCreation, guessPostRequested()).games[0].fetchState.inFlight
            ).to.eql(true);
        });
